...
test('User Can Add New Vrsta Priliva With Valid Values', async ({ page }) => {
    ...
    page.click('.nav-link[href="vrste_priliva.php"]');
...
test('User Can Successfully Exit Modal For Adding New Vrsta Priliva', async ({page}) => {
...
test('User Cannot Add New Vrsta Priliva With Invalid Values 1', async ({ page }) => {
...
test('User Cannot Add New Vrsta Priliva With Invalid Values 2', async ({ page }) => {
...
test('User Cannot Add New Vrsta Priliva With Invalid Values 3', async ({ page }) => {
...
test('User Can Edit Vrsta Priliva With Valid Values', async ({ page }) => {
...
test('User Can Successfully Exit Modal for Editing Vrsta Priliva', async ({page}) => {
...
test('User Cannot Change Existing Vrsta Priliva With Invalid Values 1', async ({ page }) => {
...
test('User Cannot Change Existing Vrsta Priliva With Invalid Values 2', async ({ page }) => {
...
test('User Can Successfully Edit Status of Vrsta Priliva', async ({ page }) => {
...
test('User Can Successfully Delete Vrsta Priliva', async ({ page }) => {
...
test('User Can Successfully Cancel Deleting Vrsta Priliva', async ({ page }) => {
