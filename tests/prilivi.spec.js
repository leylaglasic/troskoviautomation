...
test('User Can Add New Priliv With Valid Values', async ({ page }) => {
    ...
    page.click('.nav-link[href="prilivi.php"]');
    ...
    const elementId = 'vrsta_priliva_id';
    await page.waitForSelector(`#${elementId}`, { state: 'attached' });
    await page.waitForTimeout(500);


    const optionValueToSelect = 'dzeparac';
...
test('User Can Successfully Exit Modal For Adding New Priliv', async ({page}) => {
...
test('User Cannot Add New Priliv With Invalid Values 1', async ({ page }) => {
...
test('User Cannot Add New Priliv With Invalid Values 2', async ({ page }) => {
...
test('User Cannot Add New Priliv With Invalid Values 3', async ({ page }) => {
...
test('User Can Edit Priliv With Valid Values', async ({page}) => {
...
test('User Can Successfully Exit Modal For Editing Priliv', async ({page}) => {
...
test('User Cannot Change Existing Priliv With Invalid Values 1', async ({page}) => {
...
test('User Cannot Change Existing Priliv With Invalid Values 2', async ({page}) => {
    ...
    const optionValueToSelect = 'Odaberi Vrstu Priliva';
    const dropdownSelector = `#${elementId}`;
...
test('User Cannot Change Existing Priliv With Invalid Values 3', async ({page}) => {
...
test('User Can Successfully Delete Priliv', async ({ page }) => {
...
test('User Can Successfully Cancel Deleting Priliv', async ({ page }) => {
